...
function App() {
    ...
    const [activeAssignMenuId, setActiveAssignMenuId] = React.useState(null);
        ...
        return (
            <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
                ...
                <button
                    ...
                    style={getButtonStyles(currentTab === "analytics")}
                    onMouseOver={(e) => handleMouseOver(e, currentTab === "analytics")}
                    onMouseOut={(e) => handleMouseOut(e, currentTab === "analytics")}
                >
                    <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ display: "block" }}>
        ...
        return (
            <div className="landing-page">
                ...
                <div className="landing-hero" style={{ padding: "80px 24px 60px", maxWidth: "1200px", margin: "0 auto", textAlign: "center" }}>
                    <h1 style={{ fontSize: "64px", marginBottom: "20px", fontWeight: "800", letterSpacing: "-2.5px" }}>The future of scheduling <span>happens with {renderAIHighlight("AI")}</span></h1>
                    ...
                    <div className="container" style={{ gridTemplateColumns: "1fr 1fr 1fr", gap: "25px", maxWidth: "1100px", margin: "0 auto 50px", textAlign: "left" }}>
                        ...
                        <div className="auth-modal">
                            ...
                            {otpSent ? (
                                ...
                                <form onSubmit={handleAuthSubmit}>
                                    ...
                                    <button type="button" className="btn-google" onClick={() => window.location.href = `${API}/login/google`}>
        ...
        <div className="dashboard-container">
            ...
            <div className={`sidebar ${sidebarCollapsed ? "collapsed" : ""}`}>
                ...
                <div className="sidebar-menu">
                    ...
                    <button 
                        onClick={() => handleTabSwitch("ai-scheduler")} 
                        className={`sidebar-item ${activeTab === "ai-scheduler" ? "active" : ""}`}
                        style={{ background: 'transparent', border: 'none', width: '100%', textAlign: 'left', cursor: 'pointer', display: 'flex', alignItems: 'center' }}
                    >
                        <span className="sidebar-item-icon">
                        ...
                        <span className="sidebar-item-text">AI Scheduler</span>
                    </button>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "25px", width: "100%" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "25px", width: "100%" }}>
                                    ...
                                    {(() => {
                                        ...
                                        return sorted.length === 0 ? (
                                            ...
                                            sorted.map((event, index) => {
                                                ...
                                                return (
                                                    <div key={index} className={`event-card priority-card-${event.priority.toLowerCase()} ${colorClass}`}>
                                                        <div className="event-header">
                                                            ...
                                                            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                                                                ...
                                                                <button 
                                                                    ...
                                                                    style={{ background: "transparent", border: "none", padding: "4px", cursor: "pointer", color: "var(--text-muted)", transition: "color 0.2s" }}
                            ...
                            <div className="card" id="assignmentSection" style={{ width: "100%", minHeight: "260px" }}>
                                ...
                                <div className="scroll-panel" style={{ maxHeight: "250px", paddingBottom: activeAssignMenuId ? "120px" : "15px", transition: "padding-bottom 0.2s ease" }}>
                                    {(() => {
                                        const filtered = selectedCalendarDate 
                                        ...
                                        return sorted.length === 0 ? (
                                            ...
                                            sorted.map((assign, index) => (
                                                <div 
                                                    ...
                                                    onClick={() => setActiveAssignMenuId(activeAssignMenuId === assign.id ? null : assign.id)}
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "25px", width: "100%", animation: "fadeIn 0.3s ease-in-out" }}>
                        ...
                        <div className={`ai-unified-console ${aiSidebarCollapsed ? 'sidebar-collapsed' : ''}`}>
                            ...
                            <div className="ai-console-sidebar">
                                <div style={{ 
                                    ...
                                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                                        <h4 style={{ fontSize: "12px", fontWeight: "800", color: "var(--text-muted)", margin: 0, textTransform: "uppercase", letterSpacing: "0.5px" }}>Model Settings</h4>
                                        <button
                                            type="button"
                                        ...
                                        >
                                            <span>{showAiSettings ? "Close" : "Configure"}</span>
                                            <span></span>
                                        </button>
                                    </div>

                                    {!showAiSettings ? (
                                        <div style={{ background: "rgba(139, 92, 246, 0.02)", borderRadius: "10px", padding: "12px", border: "1px solid var(--border)", fontSize: "11px", color: "var(--text-muted)" }}>
                                            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "4px" }}>
                                                <span>Engine:</span>
                                                <span style={{ fontWeight: "700", textTransform: "capitalize" }}>{aiEngine === "keyword" ? "Keyword Fallback" : aiEngine}</span>
                                            </div>
                                            {aiEngine !== "keyword" && (
                                                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "4px" }}>
                                                    <span>Model:</span>
                                                    <span style={{ fontWeight: "700", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", maxWidth: "120px" }}>
                                                        {aiModel ? aiModel.split("/").pop() : "Default"}
                                                    </span>
                                                </div>
                                            )}
                                            <div style={{ display: "flex", justifyContent: "space-between" }}>
                                                <span>Status:</span>
                                                {aiEngine === "ollama" ? (
                                                    <span style={{ fontWeight: "700", color: ollamaConnected ? "#10b981" : "#ef4444" }}>
                                                        {ollamaConnected ? "Connected" : "Offline"}
                                                    </span>
                                                ) : (
                                                    <span style={{ fontWeight: "700", color: "#10b981" }}>Ready</span>
                                                )}
                                            </div>
                                        </div>
                                    ) : (
                                        <div className="glass-panel" style={{ 
                                            ...
                                            <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                                                <label style={{ fontSize: "10px", fontWeight: "800", color: "var(--text-muted)", textTransform: "uppercase" }}>AI Provider</label>
                                                <select
                                                    value={aiEngine}
                                                    onChange={(e) => {
                                                        ...
                                                        let defModel = "";
                                                        if (eng === "openrouter") defModel = "openrouter/free";
                                                        else if (eng === "huggingface") defModel = "meta-llama/Meta-Llama-3-8B-Instruct";
                                                        else if (eng === "ollama") defModel = ollamaModels.length > 0 ? ollamaModels[0] : "";
                                                ...
                                                >
                                                    <option value="keyword">Keyword Parser (Standard)</option>
                                            ...
                                            {aiEngine === "openrouter" && (
                                                <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                                                    <label style={{ fontSize: "10px", fontWeight: "800", color: "var(--text-muted)", textTransform: "uppercase" }}>OpenRouter API Key</label>
                                                    <input
                                                        type="password"
                                                        placeholder="Paste custom key (optional)"
                                                        value={openrouterKey}
                                                        onChange={(e) => {
                                                    ...
                                                    <span style={{ fontSize: "9px", color: "var(--text-muted)", lineHeight: "1.2" }}>
                                                        Leave empty to use server shared key!
                                                    </span>
                                                </div>
                                            )}
                                            ...
                                            {aiEngine === "huggingface" && (
                                                <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                                                    <label style={{ fontSize: "10px", fontWeight: "800", color: "var(--text-muted)", textTransform: "uppercase" }}>HF Access Token</label>
                                                    <input
                                                        type="password"
                                                        placeholder="hf_..."
                                                        ...
                                                        onChange={(e) => {
                                                            ...
                                                            localStorage.setItem("huggingfaceToken", e.target.value);
                                                        }}
                                                        onBlur={() => saveAiSettings(aiEngine, aiModel, openrouterKey, huggingfaceToken)}
                                                        style={{
                                                            width: "100%",
                                            ...
                                            {aiEngine !== "keyword" && (
                                                <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                                                    <label style={{ fontSize: "10px", fontWeight: "800", color: "var(--text-muted)", textTransform: "uppercase" }}>Model Name</label>
                                                    {aiEngine === "ollama" ? (
                                                        ollamaModels.length > 0 ? (
                                                            <select
                                                                ...
                                                                onChange={(e) => {
                                                                    ...
                                                                    saveAiSettings(aiEngine, e.target.value, openrouterKey, huggingfaceToken);
                                                                }}
                                                                style={{
                                                                    width: "100%",
                                                                    padding: "6px 8px",
                                                        ...
                                                        >
                                                                                            {aiEngine === "openrouter" ? (
                                                                <>
                                                                    <option value="openrouter/free">Auto-Select Free Model (Guaranteed Online)</option>
                                                                ...
                                                                <>
                                                                    <option value="meta-llama/Meta-Llama-3-8B-Instruct">Llama 3 8B (Free Serverless)</option>
                                                                    <option value="mistralai/Mistral-7B-Instruct-v0.2">Mistral 7B (Free Serverless)</option>
                                                                    <option value="microsoft/Phi-3-mini-4-instruct">Phi-3 Mini (Free Serverless)</option>
                                                                </>
                                                            )}
                                                        </select>
                                                    )}
                                            ...
                                            <div style={{ display: "flex", gap: "6px", alignItems: "center", marginTop: "4px" }}>
                                                <span style={{
                                                    ...
                                                    height: "8px",
                                                    borderRadius: "50%",
                                                    background: aiEngine === "ollama" ? (ollamaConnected ? "#10b981" : "#ef4444") : "#10b981",
                                                    boxShadow: aiEngine === "ollama" ? (ollamaConnected ? "0 0 6px #10b981" : "0 0 6px #ef4444") : "0 0 6px #10b981",
                                                    animation: aiEngine === "ollama" && !ollamaConnected ? "none" : "pulse 1.5s infinite"
                                                }}></span>
                                                <span style={{ fontSize: "10.5px", fontWeight: "600", color: "var(--text-muted)" }}>
                                                    {aiEngine === "keyword" ? "Keyword Engine Ready" : (aiEngine === "ollama" ? (ollamaConnected ? "Ollama Connected" : "Ollama Offline") : "Cloud Free API Ready")}
                                                </span>
                                            </div>
                                        </div>
                                    )}
                            ...
                            <div className="ai-console-chat">
                                {/* Chat Panel Header */}
                                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid var(--border)", paddingBottom: "12px", marginBottom: "15px" }}>
                                                    ...
                                                    <div key={index} style={{
                                                        ...
                                                        <div style={{ display: "flex", flexDirection: "column", alignItems: isAI ? "flex-start" : "flex-end" }}>
                                                            <div style={{
                                                                ...
                                                                {isAI ? renderAIHighlight(msg.text) : msg.text}
                                                            </div>
                            ...
                            <div className="grid-2-col" style={{ gap: "25px", marginBottom: "35px" }}>
                                ...
                                <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                                    <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                                        ...
                                        >
                                            <option value="Balanced Study Plan">Balanced Study Plan</option>
                                            <option value="Exam Preparation">Exam Preparation</option>
                                            <option value="Assignment Focus">Assignment Focus</option>
                                            <option value="Productivity Boost">Productivity Boost</option>
                                            <option value="Weekend Planner">Weekend Planner</option>
                                        </select>
                                    </div>
                                    ...
                                    <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                                        ...
                                        <select 
                                            ...
                                            onChange={(e) => setScheduleIntensity(e.target.value)}
                                            style={{
                                                width: "100%",
                                                padding: "12px 16px",
                                                borderRadius: "10px",
                                        ...
                                        >
                                            ...
                                            <option value="Moderate">Moderate Study</option>
